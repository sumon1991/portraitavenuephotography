jQuery(document).ready(function($){
	...
	$.fn.changeInput = function (attr,view,type,rev){
			...
			if(type == 'checkbox'){
				...
				$('.input_'+attr).closest('.form-group').hide();
			}
			else if(type == 'radio'){
				$('input[name="'+attr+'"]').rules("remove");
				$('input[name="'+attr+'"]').attr("checked", false);
			...
			if(type == 'checkbox' || type == 'radio'){
				$('.input_'+attr).closest('.form-group').delay("slow").fadeIn("slow");
			}
			else {
				$('#'+attr).closest('.form-group').delay("slow").fadeIn("slow");
			}
                }
        }
	$.fn.changeTax = function (tax,view,rev){
			...
			$('#'+tax).closest('.form-group').hide();
                }
                else if(view == 'show'){
			$('#'+tax).closest('.form-group').delay("slow").fadeIn("slow");
                }
        }
        $.fn.changeRel = function (rel,view,rev){
			...
			$('#rel_'+rel).closest('.form-group').hide();
                }
                else if(view == 'show'){
			$('#rel_'+rel).closest('.form-group').delay("slow").fadeIn("slow");
                }
        }
