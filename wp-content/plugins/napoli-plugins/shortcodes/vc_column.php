...
$responsive_classes = array(
	array(
		...
		'value'      => cr_get_cell_offset( 'margin-lg', 't', 80 ),
	...
	array(
		...
		'value'      => cr_get_cell_offset( 'margin-lg', 'b', 80 ),
		'group'      => 'Responsive Margins',
	),
	array(
		'type'       => 'dropdown',
	...
	array(
		...
		'value'      => cr_get_cell_offset( 'padding-md', 't', 80 ),
	...
	array(
		...
		'value'      => cr_get_cell_offset( 'padding-md', 'b', 80 ),
		'group'      => 'Responsive Paddings',
	),
	array(
		'type'       => 'dropdown',
