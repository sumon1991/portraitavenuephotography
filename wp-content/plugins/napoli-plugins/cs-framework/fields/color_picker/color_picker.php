...
class CSFramework_Option_color_picker extends CSFramework_Options {
  ...
  public function output() {
    ...
    print '<input type="text" name="'. $this->element_name() .'" value="'. $this->element_value() .'"'. $this->element_class( 'cs-field-color-picker' ) . $this->element_attributes( $this->extra_attributes() ) .'/>';
