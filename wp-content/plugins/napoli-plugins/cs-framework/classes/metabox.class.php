...
class CSFramework_Metabox extends CSFramework_Abstract{
  ...
  public function render_meta_box_content( $post, $callback ) {
    ...
    print '<div class="cs-framework cs-metabox-framework">';

      print '<input type="hidden" name="cs_section_id['. $unique .']" class="cs-reset" value="'. $section_id .'">';

      print '<div class="cs-body'. $show_all .'">';
          ...
          print '<div class="cs-nav">';
            ...
            foreach( $sections as $value ) {
              ...
              if( isset( $value['fields'] ) ) {
                ...
                print '<li><a href="#"'. $active_section .' data-section="'. $value['name'] .'">'. $tab_icon . $value['title'] .'</a></li>';
              } else {
                print '<li><div class="cs-seperator">'. $tab_icon . $value['title'] .'</div></li>';
              }
        ...
        print '<div class="cs-content">';
          ...
          foreach( $sections as $val ) {
            ...
            if( isset( $val['fields'] ) ) {
              ...
              print '<div id="cs-tab-'. $val['name'] .'" class="cs-section"'. $active_content .'>';
              print ( isset( $val['title'] ) ) ? '<div class="cs-section-title"><h3>'. $val['title'] .'</h3></div>' : '';
              ...
              foreach ( $val['fields'] as $field_key => $field ) {
                ...
                print cs_add_element( $field, $elem_value, $unique );
        ...
        print ( $has_nav ) ? '<div class="cs-nav-background"></div>' : '';
