...
class DGWT_JG_Settings {
	...
	public  function output() {
		...
		$settings =  DGWT_JG_Settings::dgwt()->settings->settings_api;
...
function dgwt_jg_hide_settings_detials_tab( $sections ) {
	$dgwt = new DGWT_JG_Settings();
	if ( $dgwt->dgwt()->settings->get_opt( 'show_details_box' ) !== 'on' && is_array( $sections ) ) {
