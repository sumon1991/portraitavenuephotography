...
var EnvatoWizard = (function($){
    ...
    function window_loaded(){
        ...
        $('.envato_default_content[name="default_content[pages]"]').on('change',function(){
        	if ($(this).val() == '1') {
        		$('#default_content_codestar').prop("checked", true );
        	}

        	if ($(this).val() == '2') {
        		$('#default_content_codestar2').prop("checked", true );
        	}
