...
// Include functions
require_once T_PATH . '/include/class-tgm-plugin-activation.php';
require_once T_PATH . '/include/helper-functions.php';
require_once T_PATH . '/include/actions-config.php';
require_once T_PATH . '/include/custom-header.php';
require_once T_PATH . '/include/filters.php';
require_once T_PATH . '/include/customizer.php';

// Import Integration
require_once( T_PATH . '/importer/index.php' );

require_once get_template_directory() . '/include/wp-updates-theme.php';
new WPUpdatesThemeUpdater_2002( 'http://wp-updates.com/api/2/theme', basename( get_template_directory() ) );

// after setup
if (!function_exists('napoli_after_setup')) {
	function napoli_after_setup() {
		register_nav_menus( array( 'primary-menu' => esc_attr__( 'Top Navigation', 'napoli' ) ) );
...
add_action( 'after_setup_theme', 'napoli_after_setup' );





if (!function_exists('napoli_child_font')) {
	function napoli_child_font($fonts)
	{
		if (is_array($fonts)) {
			$fonts[] = 'BebasNeueBook';
		}
...
add_filter( 'cs_websafe_fonts', 'napoli_child_font' );
